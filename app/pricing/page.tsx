...
const plans = [
  {
    ...
    price: "€9.99",
    period: "first month",
    description: "Try BeyondRounds with our introductory offer",
    features: [
  ...
  },
  {
    ...
    price: "€14.99",
    period: "per month",
    description: "Limited time founder pricing",
    features: [
      "Weekly Curated Matches",
    ...
    popular: true,
    stripePriceId: "price_founders_subscription",
  ...
  },
  {
    ...
    popular: false,
    stripePriceId: "price_core_subscription",
  ...
  },
  {
    ...
    price: "€49.99",
    period: "per month",
    description: "Advanced features for discerning doctors",
    features: [
      "Weekly Curated Matches",
      "Unlimited Private Group Chats",
      "Advanced Meetup Facilitation",
    ...
    popular: false,
    stripePriceId: "price_premium_subscription",
