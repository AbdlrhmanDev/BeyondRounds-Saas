...
import { Preferences } from '@/components/features/preferences/Preferences';
...
export default function PreferencesPage() {
  ...
  return <Preferences user={user as unknown as Record<string, unknown>} onNavigate={handleNavigate} />;
}